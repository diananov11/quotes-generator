...
function GetApi(event) {
  ...
  let prompt =
    "You are a generator quotes expert and love to write short quotes. You mission is to generate a quotes in 2 or 3 sentences, and use <blockquote> around the quote and at the end. Make sure to follow the user instructions.";
...
let inputForm = document.querySelector("#submit-button");
inputForm.addEventListener("click", GetApi);
